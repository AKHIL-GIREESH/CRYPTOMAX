        ...
        def viewprofiled():
            ...
            profile_home_buttond.pack()
              ...
              def change_usernamed():
                ...
                root_usernamed.configure(bg = "white")
                
                change_usernamed1_label = Label(root_usernamed , text = "Enter the new username")
                change_usernamed1.pack()
                
                change_usernamed1 = Entry(root_usernamed,bg = "#484848" , fg = "white")
                change_usernamed1.pack()

                change_usernamed2_label = Label(root_usernamed , text = "Re-enter the new username")
                change_usernamed2.pack()
                
                change_usernamed2 = Entry(root_usernamed,bg = "#484848" , fg = "white")
                change_usernamed2.pack()

                def checkingd():
                    if change_usernamed1.get() == change_usernamed2.get():
                        import mysql.connector
                        mydb = mysql.connector.connect(host="localhost",user="root",passwd = "lmao",database = "CRYPTOCURRENCY")
                        myobj = mydb.cursor()

                        global l   
                        list1 = [usernamed1.get() , l[0][1]]
                ...
                checknamed = Button(root_usernamed ,bg = "#484848" , fg = "white",command = checkingd)
                checknamed.pack()
                
            change_usernamed_button = Button(root_vpd,text = "Change Username" ,padx =50, pady = 25,bg = "#484848",fg = "white" ,command = change_usernamed)
            change_usernamed_button.pack()
            ...
            def change_passwordd():
                ...
                root_passwordd.configure(bg = "white")
                
                change_passwordd1_label = Label(root_passwordd , text = "Enter the new password")
                change_passwordd1.pack()
                
                change_passwordd1 = Entry(root_passwordd,bg = "#484848" , fg = "white")
                change_passwordd1.pack()

                change_passwordd2_label = Label(root_passwordd , text = "Re-enter the new password")
                change_passwordd2.pack()
                
                change_passwordd2 = Entry(root_passwordd,bg = "#484848" , fg = "white")
                change_passwordd2.pack()

                def checking_passwordd():
                    if change_passwordd1.get() == change_passwordd2.get():
                        import mysql.connector
                        mydb = mysql.connector.connect(host="localhost",user="root",passwd = "lmao",database = "CRYPTOCURRENCY")
                        myobj = mydb.cursor()

                        global l   
                        list2 = [passwordd.get() , l[0][2]]
                        command = "UPDATE users SET username = %s WHERE username = %s"
                        myobj.execute(command,l)
                        mydb.commit()
                ...
                checkpasswordd = Button(root_passwordd ,bg = "#484848" , fg = "white",command = checking_passwordd)
                checkpasswordd.pack()
                
            change_passwordd_button = Button(root_vpd,text = "Change password" ,padx =50, pady = 25,bg = "#484848",fg = "white" ,command = change_passwordd)
            change_passwordd_button.pack()
