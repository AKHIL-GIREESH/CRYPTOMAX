...
def main():
    ...
    def pg3d():
        ...
        def viewprofiled():
            ...
            profile_home_buttondd = Button(root_vpd,text = "Home",padx =50, pady = 25,bg = "#CF780A",fg = "#202020" ,command = pro_homedd)
            profile_home_buttondd.pack()

        Profile_buttondd = Button(root1d,text = "Profile",padx =50, pady = 25,bg = "#CF780A",fg = "#202020" ,command = viewprofiledd)
        Profile_buttondd.pack()
