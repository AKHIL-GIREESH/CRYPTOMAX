...
def main():
    ...
    def pg3d():
        ...
        def transactiond():
            ...
            transaction_deposit_buttond = Button(root_tr ,text ="Deposit",padx =50, pady = 25,bg = "#CF780A",fg = "#202020" ,command = tran_depositd)    
            transaction_deposit_buttond.pack()

            Ltran1d = Label(root1d , text = "       ",bg = "#202020")
            Ltran1d.pack()

            transaction_pay_buttond = Button(root_tr ,text ="Pay",padx =50, pady = 25,bg = "#CF780A",fg = "#202020" ,command = tran_payd)    
            transaction_pay_buttond.pack()

            Ltran4d = Label(root1d , text = "       ",bg = "#202020")
            Ltran4d.pack()

            transaction_home_buttond = Button(root_tr,text = "Home",padx =50, pady = 25,bg = "#CF780A",fg = "#202020" ,command = tran_homed)
        ...
        def conversiond():
            ...
            conversion_entryd = Entry(root_cond , width = 25 , bg = "#CF780A",fg = "#202020")
            ...
            def convertd():
                ...
                convert_labeld.insert(0,"Enter the amount in rupees",fg="#202020")
